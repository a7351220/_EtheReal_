...
export function StakeNFTModal({ show, handleClose }: StakeNFTModalProps) {
  ...
  const [pricePerToken, setPricePerToken] = useState(defaultPricePerToken);
  const [totalSupply, setTotalSupply] = useState(defaultTotalSupply);
  const [rentPricePerMonth, setRentPricePerMonth] = useState(defaultRentPricePerMonth);
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center p-4 sm:p-6 lg:p-8 z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg lg:max-w-2xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 ml-4">
          <div className="mb-4">
