  ...
  if (!isConnected) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-2xl text-gray-800">Please connect your wallet to manage your properties</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row">
      <div className="w-full md:w-1/2 md:pr-4 mb-8 md:mb-0">
        <h1 className="text-4xl font-bold mb-8 text-gray-900">Manage Real Estate NFTs</h1>
        ...
        <div className="mt-8">
          <h2 className="text-4xl font-bold mb-4 text-gray-900">Your Real Estate NFTs</h2>
          <div>
